...
build:
	...
	@echo "cmake -S . -B $(BUILD) -G Ninja -DPICO_BOARD=$(BOARD) -DSAVIA_ENABLE_BLE=$(BLE) -DSAVIA_ON_DEVICE_INFERENCE=$(INFER) -DSAVIA_WDT_SELFTEST=$(WDT_SELFTEST) -DSAVIA_MOCK_DATA=$(MOCK) (credenciales OTAA: $(if $(LORA_APP_KEY),.env,placeholders a cero))"
